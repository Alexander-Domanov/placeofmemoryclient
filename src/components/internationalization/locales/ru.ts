...
export const ru: LocaleType = {
  ...
  auth: {
      ...
      page: {
        ...
        schema: {
          ...
          password: {
            ...
            matches:
              'Пароль должен содержать 0-9, a-z, A-Z и указанные символы, кроме: #, \\, \', ", №',
          },
        },
        customErrors:
        ...
        STATUS_CODE_401_TR: {
          title: 'Ошибка входа',
          description: `Извините, произошла ошибка при попытке входа в систему. Пожалуйста, убедитесь, что предоставленные данные верны, и повторите попытку.`,
        },
        STATUS_CODE_400_TR: {
          title: 'Ошибка регистрации и входа в систему',
          description: `Извините, произошла ошибка при попытке регистрации. Пожалуйста, убедитесь, что предоставленные 
          данные верны, и повторите попытку. Если проблема сохраняется, зарегистрируйтесь с помощью другого адреса электронной почты`,
          error: 'Неправильный пароль, email или имя пользователя',
        },
        STATUS_CODE_200_TR: {
          title: 'Успешная регистрация и вход в систему',
          description: `Поздравляем! Ваша учетная запись успешно создана, и вы автоматически вошли в систему. Добро пожаловать!`,
          error:
    ...
    signUp: {
      ...
      page: {
        titleT: 'Регистрация',
        buttonGoogleT: 'Регистрация через',
        descriptionT: 'или',
        ...
        descriptionFormT:
          'Пароль должен быть не менее 6 символов, включать большие и маленькие латинские буквы, цифры и специальные символы',
        ...
        schema: {
          userName: {
            ...
            matches: `Имя пользователя должно содержать только латинские буквы, цифры, символы: "-" и "_"`,
            min: 'Минимальное количество символов: 6',
    ...
    forgotPassword: {
      ...
      page: {
        ...
        descriptionSecondT: `В целях безопасности мы не храним ваш текущий пароль. Если вы не запомнили свой пароль, вы можете сбросить его.`,
        emailT: 'АДРЕС ЭЛЕКТРОННОЙ ПОЧТЫ',
        captchaT: {
      ...
      form: {
        ...
        name: {
          ...
          rules: {
            ...
            pattern:
              'Название языка должно содержать текст только в нижнем регистре!',
        ...
        code: {
          ...
          rules: {
            ...
            pattern: 'Поле "Код" должно содержать только текст!',
        ...
        order: {
          ...
          rules: {
            ...
            pattern: 'Поле "Порядок" должно содержать только цифры!',
